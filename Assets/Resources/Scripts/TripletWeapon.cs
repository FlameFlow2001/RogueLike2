...
public class TripletWeapon : BasicWeaponScript
{
    override public void Shoot()
    {
        ...
        GameObject newProjectile1 = Instantiate(projectile, weaponOwnerPos.transform.position, Quaternion.identity);
        ...
        GameObject newProjectile2 = Instantiate(projectile, weaponOwnerPos.transform.position, Quaternion.identity);
